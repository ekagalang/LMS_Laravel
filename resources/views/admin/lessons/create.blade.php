        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 bg-white border-b border-gray-200">
                    ...
                    {{-- FORM MULAI DI SINI --}}
                    <form method="POST" action="{{ route('admin.courses.modules.lessons.store', ['course' => $course->id, 'module' => $module->id]) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div id="uploaded_file_field_container" class="mb-6" style="display: none;"> {{-- Sembunyikan awalnya --}}
                            <label for="uploaded_file" class="block text-sm font-medium text-gray-700 mb-1">Unggah File</label>
                            ...
                            <p class="mt-1 text-xs text-gray-500">Pilih file untuk diunggah (Maks: 10MB - PDF, PPT, DOC, Gambar).</p>
                        </div>
